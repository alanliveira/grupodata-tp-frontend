...
import { SubTitle } from '../../components/elements/headers';
		...
		<div className={'flex flex-col h-screen'}>
			...
			<main className={'flex-grow flex flex-col items-center'}>
				<section className={'h-full w-full'}>
					<div className={'container m-auto py-32 flex flex-col h-full gap-3'}>
						<div>
							<SubTitle className={'lg:mx-52'}>Rastreando encomendas</SubTitle>
						</div>
